...
<div class="w" id="logo">
    <div>
    	<a href="http://localhost:8082">
    		<img src="/images/logo.gif" alt="SS资源中心" width="175" height="48"/>
    	</a> <b></b>
    </div>
</div>
            ...
            <div class="form" onselectstart="return false;">
                ...
                <div class="item item-new">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《SS资源中心用户注册协议》</a></label>
                        <span class="clr"></span>
