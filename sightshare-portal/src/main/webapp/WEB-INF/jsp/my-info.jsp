...
<title>我的信息 - SS</title>
<meta name="Keywords" content="java,SSjava" />
<meta name="description"
	content="在SS发现了数以万计的纯净资源" />
							...
							<div class="mt">
								<ul class="extra-l">
									<li class="fore-1"><a class="curr"
										href="http://localhost:8082/personal/info.html">基本信息</a></li>
									<li class="fore-2"><a
										href="http://localhost:8082/personal/img.html">头像照片</a></li>
									<li class="fore-3"><a
										href="http://localhost:8082/personal/more.html">更多个人信息</a></li>
									...
									<div class="form">
										<div class="item">
											...
											<div class="fl">
												<input type="text" class="itxt" maxlength="20" id="nickName"
													name="userVo.nickName" value="Aaron Yang">
													<div class="clr"></div>
													<div class="prompt-06">
										...
										<div class="item">
											...
											<div class="fl interest-list">
												...
												<ul class="hobul">
													<li name="hobbyType" value="1">unity3D虚拟资源/2D贴图/游戏特效<s></s></li>
													<li name="hobbyType" value="2">JAVA文档<s></s></li>
													<li name="hobbyType" value="3">大数据方向<s></s></li>
													<li name="hobbyType" value="4">深度学习心得交流<s></s></li>
													<li name="hobbyType" value="5">自然语言处理<s></s></li>
													<li name="hobbyType" value="6">人工智能/神经算法<s></s></li>
													<li name="hobbyType" value="7">破解软件/注册机<s></s></li>
													<li name="hobbyType" value="8">Liunx运维<s></s></li>
													<li name="hobbyType" value="9">移动开发/Android<s></s></li>
													<li name="hobbyType" value="10">移动开发/IOS<s></s></li>
													<li name="hobbyType" value="11">虚拟现实VR/增强现实AR<s></s></li>
													<li name="hobbyType" value="12">C/C++/Basic<s></s></li>
												</ul>
											</div>
										</div>
										<div class="item">
											...
											<div class="fl">
												<div>
													<strong> aa*****0628@gmail.com </strong><a target="_blank"
														class="ml5 ftx05"
										...
										<div class="item">
											...
											<div class="fl">
												<input type="text" class="itxt" maxlength="20"
													name="userVo.realName" id="realName" value="杨 博">
													<div class="clr"></div>
													<div class="prompt-06">
										...
										<div class="item">
											...
											<div class="fl">
												...
												<select name="userVo.city" class="selt mr5" id="city"
													value="2817">
													<option value="2817">西湖区</option>
													<option value="2810">上城区</option>
													<option value="2811">下城区</option>
													<option value="2813">江干区</option>
													<option value="2815">拱墅区</option>
													<option value="2820">滨江区</option>
													<option value="2822">萧山区</option>
													<option value="2823">余杭区</option>
													<option value="2824">富阳区</option>
												</select> 
												<select name="userVo.county" class="selt mr5" id="county"
													value="2864"><option value="2864">西园八路</option>
												</select>
												<div class="clr"></div>
												<div class="prompt-06">
										...
										<div class="item">
											...
											<div class="fl">
												<input type="text" class="itxt itxt1" name="userVo.address"
													id="address" value="杭州市西湖区西园八路E30中心0333室">
													<div class="clr"></div>
													<div class="prompt-06">
							...
							<dd class="fore2">
								<div class="item" id="_MYJD_credit">
									<a clstag="homepage|keycount|home2013|hbt" tag="213"
										href="http://baitiao.jd.com/creditUser/record">SS资源中心白条</a>&nbsp;
								</div>
							</dd>
							<dd class="fore3">
								<div class="item" id="_MYJD_tx">
									<a target="_blank" clstag="homepage|keycount|home2013|htx"
										href="http://mobile.jd.com/yyswt/myjd.do">SS资源中心通信</a>
								</div>
							</dd>
							<dd class="fore4">
							...
							<dd class="fore6">
								<div class="item" id="_MYJD_card">
									<a target="_blank" clstag="homepage|keycount|home2013|he"
										href="http://giftcard.jd.com/giftcard/index.action">SS资源中心卡/E卡</a>
								</div>
							</dd>
							<dd class="fore7 last">
