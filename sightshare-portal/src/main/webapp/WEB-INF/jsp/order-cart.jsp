...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img src="/images/logo.gif" alt="SS商城"></a></div>
</div>
...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<c:forEach items="${cartList }" var="cart" varStatus="status">
			...
			<input type="hidden" name="orderItems[${status.index}].num" value="${cart.number }"/>
			<input type="hidden" name="orderItems[${status.index}].price" value="${cart.price}"/>
			<input type="hidden" name="orderItems[${status.index}].totalFee" value="${cart.price * cart.number}"/>
		...
		<input type="hidden" name="orderShipping.receiverName" value="Aaron Yang"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="17682349727"/>
		...
		<input type="hidden" name="orderShipping.receiverAddress" value="西园八路E30中心"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">Aaron Yang</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">176****9727</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">浙江省 杭州市 西湖区</div>
						<div class="adr-m" limit="30">西园八路E30中心</div>
...
<div class="shopping-list ABTest">
	<div class="goods-list">
     <!--配送方式-->
    <h4 class="vendor_name_h" id="0">商家：SS资源中心</h4>		         
		...
		<div class="goods-item goods-item-extra">
			...
			<div class="goods-msg">
				...
				<div class="p-price">
					...
					<!--增加预售金额显示 end-->
					<span class="ml20"> x${cart.number} </span> 
		...
		<div class="mode-tab-nav">
			<ul>
				<li class="mode-tab-item " id="jd_shipment_item"
					...
					id="jdShip-span-tip" class="m-txt">云镜像<i
						class='qmark-icon qmark-tip'
