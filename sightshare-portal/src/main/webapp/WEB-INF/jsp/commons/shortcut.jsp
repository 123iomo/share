...
<div id="shortcut-2013">
	<div class="w">
		<ul class="fl lh">
			<li class="fore1 ld" clstag="homepage|keycount|home2013|01a"><b></b><a href="javascript:addToFavorite()" rel="nofollow">收藏SS</a></li>
		</ul>
		<ul class="fr lh">
			<li class="fore1" id="loginbar" clstag="homepage|keycount|home2013|01b">您好！这里是SS资源分享中心！<a href="javascript:login()">[登录]</a>&nbsp;<a href="javascript:regist()">[免费注册]</a></li>
			<li class="fore2 ld" clstag="homepage|keycount|home2013|01c">
				<s></s>
				<a href="http://localhost:8082/cart/cart.html">我的订单</a>
			</li>
			<li class="fore3 ld menu" id="app-jd" data-widget="dropdown" clstag="homepage|keycount|home2013|01d">
				...
				<a href="http://localhost:8082" target="_blank">SS APP</a><b></b>
			</li>
			...
			<li class="fore5 ld menu" id="site-nav" data-widget="dropdown" clstag="homepage|keycount|home2013|01f">
				...
				<div class="dd lh">
					<dl class="item fore1">
						<dt>特色栏目</dt>
						<dd>
							<div><a target="_blank" href="/">通信服务</a></div>
							<div><a target="_blank" href="/">校园推广</a></div>
							<div><a target="_blank" href="/">为我推荐</a></div>
							<div><a target="_blank" href="/">SS社区</a></div>
							<div><a target="_blank" href="/">远程装机</a></div>
							<div><a target="_blank" href="/">科技感</a></div>
							<div><a target="_blank" href="/">科技新闻</a></div>
