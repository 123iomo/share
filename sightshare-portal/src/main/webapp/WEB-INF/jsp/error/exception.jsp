...
<body id="mainframe">
	<div class="w w1 header clearfix">
		<div id="logo">
			<a href="/"><img src="/images/logo.gif" alt="SS资源中心"></a>
		</div>
	</div>
...
#refresh .m .fore4 a {
	...
	font-size: 12px
			...
			<span class="txt">Oop!...不见了...</span>
			<ul class="m">
				<li class="fore1">您可以：稍后再试或联系客服400-8888-8888。
				</li>
				<li class="fore2">返回<a href="http://localhost:8082/index.html" target="_blank">中心首页</a></li>
