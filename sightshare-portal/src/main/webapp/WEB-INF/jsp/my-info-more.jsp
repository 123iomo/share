                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <div id="cidShowDiv" style="">
                                                <strong>142******717</strong>
												<a class="smod" href="javascript:showCidDiv()">修改</a>
                                            </div>
                                            <div id="cidInputDIv" style="display:none">
                                                <input name="userVo.cid" id="cid" value="" maxlength="18" type="text" class="itxt">
