...
!function() {
    ...
    a = $.extend({loginService: "" ,loginUrl: "",returnUrl: location.href,automatic: !0,complete: null,modal: !1}, a || {}), "" != a.loginService && "" != a.loginMethod && $.getJSON(a.loginService, {method: a.loginMethod}, function(b) {
...
var jdModelCallCenter = {settings: {clstag1: 0,clstag2: 0},tbClose: function() {
        ...
        return c ? (location.href = "", void 0) : (setTimeout(function() {
            $.jdThickBox({type: "iframe",title: "\u60a8\u5c1a\u672a\u767b\u5f55",source: "" + a.settings.clstag1 + "&clstag2=" + a.settings.clstag2 + "&r=" + Math.random(),width: 390,height: 450,_title: "thicktitler",_close: "thickcloser",_con: "thickconr"})
        }, 20), void 0)
    },regist: function() {
        var a = this;
...
var category = {OBJ: $("#_JD_ALLSORT"),
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://localhost:8082" + c + ".html" : "http://localhost:8082" + c), '<a href="' + c + '">' + d + "</a>")
        ...
        switch (a) {
            case "c":
                b = '<div class="categorys-links" ' + c + '><a href="/" target="_blank"><img src="http://192.168.231.129/images/2017/02/07/1486453134527932.jpg" /></a></div>';
                break;
            case "b":
      ...
      //  $.getJSONP(this.URL_BrandsServ, category.getBrandService)
        ...
        "function" == typeof a && $.getJSON("", function(b) {
