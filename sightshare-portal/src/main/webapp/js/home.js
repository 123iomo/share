...
(function() {
    ...
    new BackPanelNew({id: "backpanel0708",start: 10}).init({text: "\u8fd4\u56de\u9876\u90e8",fn: function() {
        ...
        var t = $("#shortcut-2013 .fl").eq(0).find(".fore1"), e = '            <li class="fore2 jd-wx-qrcode">                <a href="#none"><i class="i-qrcode"></i>微信分支</a>                <div class="qrcode-show">                    <span class="arrow">                        <i class="layer1"></i><i class="layer2"></i>                    </span>                </div>            </li>';
